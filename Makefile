...
am_minerd_OBJECTS = minerd-cpu-miner.$(OBJEXT) minerd-util.$(OBJEXT) \
	...
	minerd-whirlpool.$(OBJEXT) minerd-whirlcoin.$(OBJEXT)
...
include ./$(DEPDIR)/minerd-whirlcoin.Po
include ./$(DEPDIR)/minerd-whirlpool.Po
...
minerd-whirlpool.o: whirlpool.c
	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT minerd-whirlpool.o -MD -MP -MF $(DEPDIR)/minerd-whirlpool.Tpo -c -o minerd-whirlpool.o `test -f 'whirlpool.c' || echo '$(srcdir)/'`whirlpool.c
	$(am__mv) $(DEPDIR)/minerd-whirlpool.Tpo $(DEPDIR)/minerd-whirlpool.Po
#	source='whirlpool.c' object='minerd-whirlpool.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o minerd-whirlpool.o `test -f 'whirlpool.c' || echo '$(srcdir)/'`whirlpool.c

minerd-whirlpool.obj: whirlpool.c
	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT minerd-whirlpool.obj -MD -MP -MF $(DEPDIR)/minerd-whirlpool.Tpo -c -o minerd-whirlpool.obj `if test -f 'whirlpool.c'; then $(CYGPATH_W) 'whirlpool.c'; else $(CYGPATH_W) '$(srcdir)/whirlpool.c'; fi`
	$(am__mv) $(DEPDIR)/minerd-whirlpool.Tpo $(DEPDIR)/minerd-whirlpool.Po
#	source='whirlpool.c' object='minerd-whirlpool.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o minerd-whirlpool.obj `if test -f 'whirlpool.c'; then $(CYGPATH_W) 'whirlpool.c'; else $(CYGPATH_W) '$(srcdir)/whirlpool.c'; fi`

minerd-whirlcoin.o: whirlcoin.c
	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT minerd-whirlcoin.o -MD -MP -MF $(DEPDIR)/minerd-whirlcoin.Tpo -c -o minerd-whirlcoin.o `test -f 'whirlcoin.c' || echo '$(srcdir)/'`whirlcoin.c
	$(am__mv) $(DEPDIR)/minerd-whirlcoin.Tpo $(DEPDIR)/minerd-whirlcoin.Po
#	source='whirlcoin.c' object='minerd-whirlcoin.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o minerd-whirlcoin.o `test -f 'whirlcoin.c' || echo '$(srcdir)/'`whirlcoin.c

minerd-whirlcoin.obj: whirlcoin.c
	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT minerd-whirlcoin.obj -MD -MP -MF $(DEPDIR)/minerd-whirlcoin.Tpo -c -o minerd-whirlcoin.obj `if test -f 'whirlcoin.c'; then $(CYGPATH_W) 'whirlcoin.c'; else $(CYGPATH_W) '$(srcdir)/whirlcoin.c'; fi`
	$(am__mv) $(DEPDIR)/minerd-whirlcoin.Tpo $(DEPDIR)/minerd-whirlcoin.Po
#	source='whirlcoin.c' object='minerd-whirlcoin.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o minerd-whirlcoin.obj `if test -f 'whirlcoin.c'; then $(CYGPATH_W) 'whirlcoin.c'; else $(CYGPATH_W) '$(srcdir)/whirlcoin.c'; fi`
